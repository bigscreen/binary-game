...
public abstract class CustomCountDownTimer {
     ...
     * @param runAtStart
     */
    public CustomCountDownTimer(long millisOnTimer, long countDownInterval, boolean runAtStart) {
     ...
     * Start the countdown.
     */
    public synchronized final CustomCountDownTimer restart(long millisOnTimer) {
        mMillisInFuture = millisOnTimer;
        mCancelled = false;
        if (mMillisInFuture <= 0) {
            onFinish();
    ...
    public boolean isPaused () {
        Log.e("CountDownTimer", "state=" + mPauseTimeRemaining);
